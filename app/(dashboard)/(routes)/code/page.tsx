...
import { Code, CodeIcon, MessageSquare } from 'lucide-react';
                  ...
                  <FormItem className="col-span-12 lg:col-span-10">
                    <FormControl className="m-0 p-0">
                      <Input
                        ...
                        disabled={isLoading} 
                        placeholder="Java Program to print factorial of a number" 
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
...
export default CodeGeneratioPage;
